...
am4core.ready(function() {
	...
	var activeColor = am4core.color("#fb6340");
	var confirmedColor = am4core.color("#d21a1a");
	var recoveredColor = am4core.color("#2dce89");
	var deathsColor = am4core.color("#f5356c");

	// for an easier access by key
	var colors = { active: activeColor, confirmed: confirmedColor, recovered: recoveredColor, deaths: deathsColor };

	var countryColor = am4core.color("#5e72e4");
	...
	title.text = "Coronavirus Live Stats World Map";
	title.align = "left";
	...
	mapGlobeSwitch.events.on("toggled", function() {
		if (mapGlobeSwitch.isActive) {
			...
			mapChart.deltaLatitude = -20.5937;
			mapChart.deltaLongitude = -78.9629;
			mapChart.responsive.enabled = true;
		} else {
			mapChart.projection = new am4maps.projections.Miller;
	...
	sizeSlider.height = am4core.percent(25);
